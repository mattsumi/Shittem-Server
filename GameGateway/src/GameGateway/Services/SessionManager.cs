...
public class SessionManager
{
    ...
    public void SetLoadBalancerCookies(HttpContext httpContext)
    {
        ...
        httpContext.Response.Cookies.Append("LB", lbValue, cookieOptions);
        httpContext.Response.Cookies.Append("LBCORS", lbCorsValue, cookieOptions);
        
        _logger.LogDebug("Set load balancer cookies: LB={LB}, LBCORS={LBCORS}", lbValue, lbCorsValue);
    }
