📦
143205 /ba_bypass_src.js
74606 /ba_bypass_src.js.map
✄
...
// ba_bypass_src.js
init_node_globals();
var bridge = (init_dist(), __toCommonJS(dist_exports));
var Il2Cpp2 = bridge.Il2Cpp || bridge.default || bridge;
...
function tryHookChaCha() {
  ...
  for (const name of classNames) {
    const klass = Il2Cpp2 && Il2Cpp2.classes ? Il2Cpp2.classes[name] : null;
    if (!klass) continue;
...
function tryHookCompression() {
  ...
  for (const [klassName, methods] of candidates) {
    const klass = Il2Cpp2 && Il2Cpp2.classes ? Il2Cpp2.classes[klassName] : null;
    if (!klass) continue;
...
async function waitAndHook() {
  try {
    const hasInitialize = Il2Cpp2 && typeof Il2Cpp2.initialize === "function";
    const hasPerform = Il2Cpp2 && typeof Il2Cpp2.perform === "function";
    const needModule = "GameAssembly.dll";
    const start = Date.now();
    while (!Module.findBaseAddress(needModule) && Date.now() - start < 3e4) {
